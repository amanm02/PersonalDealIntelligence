...
This file tracks banking improvements that should wait until the Banking MVP is usable and validated.

## Status

Deferred until the Banking MVP demo and release checklist pass.
...
- More compliant public sources.
- RSS/feed expansion.
- User-provided newsletter exports.
- Manual URL intake improvements.
...
Move an item from this file into an active GitHub Issue only when:

- the Banking MVP is complete enough that the work is not blocking the first demo;
