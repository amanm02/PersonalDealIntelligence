...
| `tools/agentops/check_context_budget.py` | Warn when agent entry docs exceed context budget targets | read | repo docs | warning-only output | `make workflow-hygiene` | active |
