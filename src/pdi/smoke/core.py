...
def _source_policy(fixture: SmokeFixture) -> SourcePolicy:
    return SourcePolicy(
        ...
        source_group="demo",
        publisher_name=fixture.source_name,
        name=fixture.source_name,
        url=fixture.source_url,
        source_type=fixture.source_type,
        source_class="official" if fixture.source_type == "official_promo_page" else "third_party",
        category_scope=("banking",),
        subcategory_scope=(fixture.subcategory,),
        coverage_purpose="Synthetic offline smoke fixture source.",
        trust_tier="official" if fixture.source_type == "official_promo_page" else "community",
        official_source=fixture.source_type == "official_promo_page",
        deposit_account_source=fixture.subcategory
        in {
            "checking_bonus",
            "savings_bonus",
        ...
        brokerage_source=fixture.subcategory == "brokerage_bonus",
        credit_card_source=fixture.subcategory == "credit_card_signup_bonus",
        fixture_enabled=True,
        source_priority=80 if fixture.source_type == "official_promo_page" else 50,
        region_scope=("US",),
        enabled=True,
        collection_method="manual_only",
